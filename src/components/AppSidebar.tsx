            ...
            <SidebarMenu>
              ...
              {user && (
                <>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild>
                      <Link to="/simulation" className="flex px-4 h-8 w-full items-center space-x-3 text-sm rounded-md text-muted-foreground transition-all hover:text-foreground hover:bg-secondary">
